...
class RadialAverager(object):
    ...
    def bin_centers(self):
        return (np.arange(self.n_bins) + 0.5) / self._bin_factor
    
    


def angular_average_old(image, mask=None, rad=None, center=None, threshold=None, nx=None,pixel_size=None, photon_energy=None, detector_distance=None, min_x=None, max_x=None):
